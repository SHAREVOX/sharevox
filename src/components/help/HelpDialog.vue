...
const pagedata = computed(() => {
  const data: PageData[] = [
    ...
    },
    {
      ...
      props: {
        downloadLink: "https://sharevox.app/",
    ...
    },
    {
      ...
      props: {
        downloadLink: "",
        updateInfos: voicevoxUpdateInfos.value,
