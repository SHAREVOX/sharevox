...
`C:\Users\(ユーザー名)\AppData\Roaming\sharevox\logs`

#### Mac 版

`/Users/(ユーザー名)/Library/Application Support/sharevox/logs`
...
概要欄に記載いただければ検索などで見つけやすくなるため、SHAREVOX 開発の励みになります。
...
SHAREVOX は、キャラクターとソフトウェアで権利者が異なります。
キャラクターに関することを SHAREVOX からお答えすることはできません。
